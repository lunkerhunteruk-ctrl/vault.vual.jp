    ...
    locations: [
      {
        id: "gamecenter",
        name: "GAME CENTER",
        implantPrompt: "とうきょう しんじゅく ゲームセンター",
        film: "leicaPortra800",
        media: [
          { file: `${R2_BASE}/23-05-2026/look3.jpg`, type: "image", aspect: "16:9", isHero: true },
          { file: `${R2_BASE}/23-05-2026/look1.jpg`, type: "image", aspect: "3:4" },
    ...
    locations: [
      {
        ...
        media: [
          ...
          { file: `${R2_BASE}/16-05-2026/look1.jpg`, type: "image", aspect: "3:4" },
          { file: `${R2_BASE}/16-05-2026/look2.jpg`, type: "image", aspect: "3:4" },
          { file: `${R2_BASE}/16-05-2026/look3.jpg`, type: "image", aspect: "3:4" },
          { file: `${R2_BASE}/16-05-2026/look4.jpg`, type: "image", aspect: "3:4" },
        ],
      },
    ],
  },
